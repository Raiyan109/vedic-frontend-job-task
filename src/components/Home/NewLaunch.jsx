    ...
    return (
        <div>
            ...
            <div className='relative lg:left-[800px] lg:bottom-[940px] sm:left-80 sm:bottom-[450px]'>
                <h1 className='mb-5 lg:text-5xl text-3xl text-primary font-bold'>New Launch</h1>
            </div>
            <div className="hero min-h-screen relative sm:bottom-[500px] lg:bottom-[1150px] p-20 lg:p-40">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        <h1 className="text-5xl font-bold text-primary">Energy Calculator
                        </h1>
                        <p className="py-6 text-primary">It is a long established fact that a reader will be distracted by the readable
